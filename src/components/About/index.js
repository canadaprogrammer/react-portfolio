    ...
    <>
      <div className="container about-page">
        <div className="text-zone">
          ...
          <p>
            Solving problems, organizing well, and working independently with
            high attention to detail.
          </p>
          <p>
            IRiding a bicycle, walking on the beach, and watching movies. A
            family person and father of two lovely children.
          </p>
        </div>
